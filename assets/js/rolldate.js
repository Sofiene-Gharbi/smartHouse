...
(function(global, factory) {
    ...
    var bscroll_min = createCommonjsModule(function(module, exports) {
        ...
        !(function(t, i) {
            ...
            var l = function(t, i) {
                ...
                if (Symbol.iterator in Object(t))
                    return (function(t, i) {
                        ...
                        try {
                            for (
                                var r, h = t[Symbol.iterator](); !(s = (r = h.next()).done) &&
                                (e.push(r.value), !i || e.length !== i); s = !0
                            );
                        } catch (t) {
                            (o = !0), (n = t);
                        } finally {
            ...
            function a(t) {
                for (
                    var i = arguments.length, e = Array(1 < i ? i - 1 : 0), s = 1; s < i; s++
                )
                    e[s - 1] = arguments[s];
            ...
            function E(t, i, e, s, o, n, r) {
                ...
                return (
                    ...
                    o < f &&
                    ((f = n ? Math.min(o + n / 4, o + (n / d) * a) : o), (m = p)), { destination: Math.round(f), duration: m }
                );
            }
            ...
            function A(t, i) {
                ...
                this.wrapper || I("Can not resolve the wrapper DOM."),
                    ...
                    this.scroller ||
                    I("The wrapper need at least one child element to be scroller."),
            ...
            return (
                ...
                (k.prototype._handleOptions = function(t) {
                    ...
                    (this.options.directionLockThreshold = this.options.eventPassthrough ?
                        0 :
                        this.options.directionLockThreshold), !0 === this.options.tap && (this.options.tap = "tap");
                }),
                    ...
                    if ("function" == typeof Object.defineProperty) {
                        ...
                        Object.defineProperty(this, t, {
                            ...
                            set: function(t) {
                                n = t;
                                for (
                                    var i = o.scroller.children.length ?
                                        o.scroller.children : [o.scroller],
                ...
                (k.prototype.refresh = function() {
                    var t =
                        "static" === window.getComputedStyle(this.wrapper, null).position,
                        i = b(this.wrapper);
                    ...
                    if (this.enabled && !this.destroyed && x[t.type] === this.initiated) {
                        ...
                        if (
                            ((this.directionX = 0 < s ? -1 : s < 0 ? 1 : 0),
                                (this.directionY = 0 < o ? -1 : o < 0 ? 1 : 0), !this.options.pullDownRefresh || !this._checkPullDown())
                        )
                            ...
                            if (
                                ...
                                if (this.options.snap) {
                                    ...
                                    (a =
                                        ...
                                        Math.max(
                                            Math.max(
                                                Math.min(Math.abs(i - w.x), 1e3),
                                                Math.min(Math.abs(e - w.y), 1e3)
                                            ),
                                            300
                                        )),
                                    (i = w.x),
                    ...
                    if (this.options.wheel) {
                        ...
                        return (
                            this.scrollToElement(
                                this.target,
                                this.options.wheel.adjustTime || 400, !0, !0,
                                M.swipe
                            ), !0
                        );
                    }
                ...
                (P.prototype._translate = function(t, i, e) {
                    if (
                        ...
                        for (
                            var s = this.options.wheel.rotate,
                                o = void 0 === s ? 25 : s,
                ...
                (P.prototype.scrollTo = function(t, i) {
                    ...
                    ((this.isInTransition =
                            ...
                            0 < e &&
                            (t !== this.x || i !== this.y)), !e || this.options.useTransition ?
                ...
                (P.prototype.scrollToElement = function(t, i, e, s, o) {
                    if (
                        t &&
                        ((t = t.nodeType ? t : this.scroller.querySelector(t)), !this.options.wheel ||
                            t.classList.contains(this.options.wheel.wheelItemClass))
                    ) {
                        var n = m(t);
                        (n.left -= this.wrapperOffset.left),
                        (n.top -= this.wrapperOffset.top), !0 === e &&
                            (e = Math.round(
                            ...
                            (n.top =
                                ...
                                n.top),
                            this.options.wheel &&
                            (n.top = Math.round(n.top / this.itemHeight) * this.itemHeight),
                ...
                (P.prototype.resetPosition = function() {
                    ...
                    var o = this.y,
                        n = Math.round(o);
                    return (!this.hasVerticalScroll || n > this.minScrollY ?
                        (o = this.minScrollY) :
                ...
                (P.prototype.getComputedPosition = function() {
                    ...
                    return (
                        (e = this.options.useTransform ?
                            ...
                            ((i = +t.left.replace(/[^-\d.]/g, "")), +t.top.replace(/[^-\d.]/g, ""))), { x: i, y: e }
                    );
                }),
                ...
                (O.prototype._initWheel = function() {
                    ...
                    t.wheelWrapperClass || (t.wheelWrapperClass = "wheel-scroll"),
                        ...
                        ((t.selectedIndex = 0),
                            I("wheel option selectedIndex is required!"));
                }),
                ...
                (W.prototype._onMouseWheel = function(t) {
                    ...
                    if (this.enabled) {
                        ...
                        u > this.minScrollX ?
                            (u = this.minScrollX) :
                            u < this.maxScrollX && (u = this.maxScrollX),
                            m > this.minScrollY ?
                            (m = this.minScrollY) :
    ...
    Rolldate.prototype = {
        ...
        extend: function extend(config) {
            ...
            for (var key in opts) {
                if (
                    opts[key] &&
                    Object.prototype.toString.call(opts[key]) == "[object Object]"
                ) {
                    for (var key2 in config[key]) {
                        opts[key][key2] =
                            config[key][key2] == undefined ?
                            opts[key][key2] :
                            config[key][key2];
                    }
                } else {
        ...
        createUI: function createUI() {
            var _this = this,
                ...
                ul = "",
                date = config.el ?
                $(config.el).bindDate || new Date() :
                _this.bindDate || new Date(),
                itemClass = "",
                lang = config.lang;
            ...
            var _loop = function _loop(_i) {
                ...
                var that = _this.scroll[FormatArr[_i]],
                    ...
                    Math.round(date.getMinutes() / config.minStep);
